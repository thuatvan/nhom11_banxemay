    ...
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        <h6 class="uppercase
            ...
            md:justify-start
          ">
          <img src="https://bizweb.dktcdn.net/100/443/045/themes/844966/assets/logo.png?1695197142389" alt="" class="w-[200px]">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">VỀ XE MÁY ĐIỆN</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">VỀ XE ĐẠP ĐIỆN</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">VỀ XE MÁY 50CC</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">VỀ XE GA 50CC</a>
        </p>
        <p class="mb-4">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600"> CHO NGƯỜI TIÊU DÙNG</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600"> CHO NHÂN VIÊN</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600"> TỪ THIỆN QUYÊN GÓP</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
         ...
         145 Bạch Mai quận Hai Bà Trưng, HN
        </p>
        <p class="flex items-center justify-center md:justify-start mb-4">
